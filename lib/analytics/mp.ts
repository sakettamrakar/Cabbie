...
interface ServerEventInput { client_id?:string; user_id?:string; name:string; params?:Record<string,any>; event_id?:string; }

export async function sendServerEvent({ client_id, user_id, name, params={}, event_id }: ServerEventInput){
