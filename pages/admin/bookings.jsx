...
const AdminBookingsPage = ({ accessState, initialKey }) => {
    ...
    const authKey = initialKey !== null && initialKey !== void 0 ? initialKey : '';
    ...
    const handleKeySubmit = useCallback((event) => {
    ...
    const renderUnauthorized = () => {
        ...
        <form onSubmit={handleKeySubmit} className={styles.keyForm}>
          ...
          <input id="admin-key" type="password" value={pendingKey} onChange={(event) => setPendingKey(event.target.value)} placeholder="Enter ADMIN_KEY" className={styles.input} autoComplete="off" required/>
    ...
    const renderTable = () => {
        ...
        return (<div className={styles.tableSection}>
        ...
        <div className={styles.tableWrapper}>
          <table className={styles.table}>
            ...
            <tbody>
              {bookings.map((booking) => (<tr key={booking.booking_id}>
...
export const getServerSideProps = async (context) => {
    var _a;
    const key = (_a = getAdminKeyFromQuery(context.query)) !== null && _a !== void 0 ? _a : null;
