...
export default async function handler(req, res) {
    ...
    if (req.method === 'PUT') {
        ...
        try {
            const driver = await prisma.driver.update({ where: { id }, data: { name, phone, car_type, vehicle_no: vehicle_no !== null && vehicle_no !== void 0 ? vehicle_no : null, active: active === undefined ? undefined : !!active } });
