...
export default function ModernBookingWidget({ className = "" }) {
    ...
    return (<div className={`booking-widget ${className}`}>
      ...
      <form onSubmit={handleSubmit} className="booking-form">
        ...
        <div className="booking-form-row">
          <div className="form-group">
            ...
            <input type="text" id="origin" name="origin" value={formData.origin} onChange={handleInputChange} placeholder="Enter pickup city" className="form-input form-input-lg" required/>
          </div>
          ...
          <div className="form-group">
            ...
            <input type="text" id="destination" name="destination" value={formData.destination} onChange={handleInputChange} placeholder="Enter destination city" className="form-input form-input-lg" required/>
          </div>
        </div>
        ...
        <div className="booking-form-row">
          <div className="form-group">
            ...
            <input type="date" id="pickupDate" name="pickupDate" value={formData.pickupDate} onChange={handleInputChange} className="form-input form-input-lg" min={new Date().toISOString().split('T')[0]} required/>
          </div>
          ...
          <div className="form-group">
            ...
            <input type="time" id="pickupTime" name="pickupTime" value={formData.pickupTime} onChange={handleInputChange} className="form-input form-input-lg" required/>
          </div>
        </div>
        ...
        <div className="form-group">
          ...
          <select id="passengers" name="passengers" value={formData.passengers} onChange={handleInputChange} className="form-select form-input-lg">
        ...
        {/* Submit Button */}
        <button type="submit" className="btn btn-primary btn-xl w-full mt-6 group">
