interface Props { origin:string; destination:string; car:string; fare:number; pickup:string; }
export default function BookingSummary({origin,destination,car,fare,pickup}:Props){
