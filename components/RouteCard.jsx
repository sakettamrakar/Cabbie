export function RouteCard({ origin, destination, distanceKm, fareSummary }) {
    const href = `/${origin}/${destination}/fare`;
    return (<a className="routeCard" href={href} aria-label={`View ${origin} to ${destination} cab fares`}>
