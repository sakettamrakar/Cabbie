          ...
          <div className="container">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="flex items-center">
                <a href="/" className="flex items-center space-x-3 text-primary-600 hover:text-primary-700 transition-colors">
              ...
              <div className="md:hidden">
                <button type="button" className="btn btn-ghost p-2" aria-label="Toggle navigation menu">
