  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-neutral-50 flex flex-col">
        ...
        {/* Navigation Header */}
        <header className="cabbie-header">
          <div className="container cabbie-header__container">
            <a href="/" className="cabbie-header__brand" aria-label={`${brandName} home`}>
              <Image src={logoMark} alt={`${brandName} logo`} width={140} height={36} priority />
            </a>

            <nav className="cabbie-header__nav" aria-label="Primary">
              <a href="/routes" className="cabbie-header__link">
                Browse Routes
              </a>
              <a href="/about" className="cabbie-header__link">
                About Us
              </a>
              <a href="/contact" className="cabbie-header__link">
                Contact
              </a>
              <a href="/book" className="btn btn-accent btn-sm" aria-label="Book an intercity cab">
                Book Now
              </a>
            </nav>
        ...
        <footer className="bg-neutral-800 text-white mt-auto">
          <div className="container py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="md:col-span-2">
                <div className="flex items-center space-x-3 mb-4">
                  <Image src={logoMark} alt={`${brandName} logo`} width={120} height={32} loading="lazy" />
            ...
            <div className="border-t border-neutral-700 mt-8 pt-8 text-center text-neutral-400">
              <p>&copy; {new Date().getFullYear()} {brandName}. All rights reserved. Professional intercity taxi service.</p>
            </div>
          </div>
        </footer>
