...
const NoResults = ({ onResetFilters }) => {
    return (<div className="card search-results__message" role="status">
      <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} aria-hidden="true" style={{ color: 'var(--brand-muted)' }}>
      ...
      <div className="search-results__actions">
        ...
        <button type="button" className="pill" onClick={() => window.history.back()}>
          Go back
        </button>
      </div>
    </div>);
