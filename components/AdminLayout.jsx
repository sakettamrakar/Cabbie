...
export default function AdminLayout({ title = 'Admin', description = 'Admin dashboard', children }) {
    return (<div className="admin-shell" style={{ display: 'grid', gridTemplateColumns: '240px 1fr', minHeight: '100vh', gridTemplateRows: 'auto 1fr' }}>
      ...
      <div style={{ display: 'grid', gridTemplateRows: '56px 1fr', minHeight: '100%' }}>
        ...
        console.error(e);
    } }} style={{ background: '#334155', color: '#fff', border: '1px solid #475569', padding: '6px 14px', borderRadius: 4, cursor: 'pointer' }}>Logout</button>
        </header>
